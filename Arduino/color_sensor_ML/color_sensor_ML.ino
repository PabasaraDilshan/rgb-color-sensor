...
void loop() {
 ...
 //bluescaled = (float)(blue-blueb)/(float)(bluew-blueb);
  ...
  //greenscaled = theta[1][0]+ red*theta[1][1]+ green*theta[1][2]+ blue*theta[1][3];
  //bluescaled = theta[2][0]+ red*theta[2][1]+ green*theta[2][2]+ blue*theta[2][3];
  //redscaled = red;
  //greenscaled = green;
  //bluescaled = blue;
  ...
  //Serial.println(blue);
  Serial.println(constrain(redscaled,0,255));
  Serial.println(constrain(greenscaled,0,255));
  Serial.println(constrain(bluescaled,0,255));
  analogWrite(9,255-constrain(redscaled,0,255));
  analogWrite(10,255-constrain(greenscaled,0,255));
  analogWrite(11,255-constrain(bluescaled,0,255));
